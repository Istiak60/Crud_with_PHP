                ...
                <div class="col-md-5">
                    ...
                    <form method="post" action="store.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputPro_id" name="product_id" value="">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputTitle" class="col-md-3 col-form-label">Product title:</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputPro_title" name="product_title" value="">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                <label for="inputTitle" class="col-md-3 col-form-label">Unit Price:</label>
                                <div class="col-md-9">
                                    <input type="number" class="form-control" id="inputUnitPrice" name="unit_price" value="">
                                </div>
                                <div class="mb-3 row">
