                ...
                <div class="col-md-5">
                    ...
                    <form method="post" action="update.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="email" class="form-control" id="inputEmail" name="email" value="<?= $contact['email'] ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputName" class="col-md-3 col-form-label">Subject:</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputSub" name="subject" value="<?= $contact['subject'] ?>">
                            </div>
                        </div>

                        <div class="mb-3 row">
                            <label for="inputName" class="col-md-3 col-form-label">Comment:</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputComment" name="comment" value="<?= $contact['comment'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-check">
                            <div class="col-md-9">
                                ...
                                ?>
                                    ...
                                    <input type="checkbox" class="form-check-input" id="inputStatus" name="status" value="1" checked>
                                <?php
                                }
                        ...
                        <div class="mb-3 row">
                            <label for="inputName" class="col-md-3 col-form-label">Date of Birth:</label>
                            <div class="col-md-9">
                                <input type="date" class="form-control" id="inputDate" name="date" value="<?= $contact['date'] ?>">
                            </div>
                        </div>
