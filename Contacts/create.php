    ...
    <section>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <h1 class="text-center mb-4">Add New Contacts</h1>
                    <form method="post" action="store.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputSub" name="subject" value="">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputCom" name="comment" value="">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputDate" class="col-md-3 col-form-label">DOB:</label>
                            <div class="col-md-9">
